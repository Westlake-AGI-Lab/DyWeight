...
def calculate_inception_stats(
    ...
    detector_path = find_inception_model(max_depth=3)
...
def main():
    ...
    \b
    # Calculate FID
    torchrun --standalone --nproc_per_node=1 eval/fid.py calc --images=fid-tmp \\
        --ref=https://nvlabs-fi-cdn.nvidia.com/edm/fid-refs/cifar10-32x32.npz

    \b
    # Compute dataset reference statistics
    python eval/fid.py ref --data=datasets/my-dataset.zip --dest=fid-refs/my-dataset.npz
    """
